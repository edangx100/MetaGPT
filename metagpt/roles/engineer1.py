...
from metagpt.actions import Action, WriteCode, WriteCodeReview, WriteTasks      #! WriteTasks remove use at line 95, 248
...
class Engineer1(Role):
    """
    Represents an Engineer1 role responsible for writing and possibly reviewing code.

    Attributes:
        name (str): Name of the engineer1.
        profile (str): Role profile, default is 'Engineer1'.
        goal (str): Goal of the engineer1.
        constraints (str): Constraints for the engineer1.
        n_borg (int): Number of borgs.
        use_code_review (bool): Whether to use code review.
    """

    name: str = "Alex"
    profile: str = "Engineer1"
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self._watch([Human2ReviewReq, SummarizeCode, WriteCode, WriteCodeReview, FixBug, WriteCodePlanAndChange])   #!
        self.code_todos = []
    ...
    async def _think(self) -> Action | None:
        ...
        write_code_filters = any_to_str_set([Human2ReviewReq, WriteCodePlanAndChange, SummarizeCode])        # WriteTasks -> Human2ReviewReq
